...
<head>
  ...
  <style>
    ...
    .header-content {{ position: relative; z-index: 1; height: 211px; padding: 32px 34px 0; display: flex; flex-direction: column; }}
    ...
    .header-title {{ position: relative; max-width: 470px; margin: 0; font-family: var(--font-family-din-condensed), Impact, sans-serif; font-size: 48px; line-height: .98; letter-spacing: 0; white-space: nowrap; }}
    .header-author {{ max-width: 470px; margin: 6px 0 0; font-size: 26px; line-height: 1.15; font-weight: 700; overflow-wrap: anywhere; }}
    .header-bottom {{ margin-top: auto; margin-bottom: 8px; display: flex; align-items: center; gap: 14px; }}
    .header-logo {{ flex-shrink: 0; width: 126px; height: auto; }}
    .header-event {{ max-width: 260px; margin: 0; padding: 0; font-size: 16px; line-height: 1.15; font-weight: 700; }}
    ...
    @media (max-width: 600px) {{ .prova-decklist-1 {{ min-height: 100vh; }} .header-content {{ padding-left: 22px; padding-right: 22px; }} .header-title {{ font-size: clamp(30px, 6vw, 48px); }} .header-author {{ max-width: 100%; font-size: clamp(18px, 4vw, 26px); }} .header-event {{ max-width: 210px; font-size: 13px; }} .header-logo {{ width: 88px; }} .header-stats {{ left: 22px; right: 22px; }} .body-2 {{ gap: 10px; padding-left: 22px; padding-right: 22px; }} .deck-stat + .deck-stat {{ padding-left: 12px; }} .type-summary {{ gap: 8px; }} }}
  </style>
</head>
<body>
