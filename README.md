...
The responsive HTML is written to `figma-export/figma-export/responsive-decklist.html`. The dimensions can be any positive width and height; the generated PNG fills the requested viewport without adding bands or stretching card images. Use `--export-image` to create the PNG beside the HTML, or provide a path after the option.
